...
def hello_pubsub(event, context):
    ...
    """
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/840023653147082833/fm9pjwaXMV4AGlpDPl6FR4UexhLc2WOEUgXqYXo3aTCSNY2IF_26bovEUyeAUA2mzsT0', content='<@&656976951143301166> :money_with_wings: ')
